        ...
        <header className="p-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-gray-900">RichSave</span>
            </div>
            <div className="flex gap-3">
              <button
                onClick={() => router.push('/login')}
                className="px-5 py-2 text-gray-700 font-medium hover:text-primary transition-colors"
              >
                Login
              </button>
              <button
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Save Smart,
                <span className="text-primary"> Live Rich</span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-white rounded-3xl shadow-softer p-8 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <div className="bg-gradient-to-br from-primary-400 to-primary-600 rounded-2xl p-6 text-white mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div className="text-primary font-semibold">$28</div>
                  </div>
                </div>
              </div>
            </div>
